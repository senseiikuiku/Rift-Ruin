...
#pragma warning restore 67
        ...
        protected virtual void Start()
        {
            ...
            if (TargetToFollow == null)
            {
                ...
                // Chỉ gán và xử lý nếu tìm thấy Player
                if (player != null)
                {
                ...
                {
                    // Nếu chưa có player (Multiplayer chưa Start), in log thông báo thay vì báo lỗi đỏ
                    Debug.Log("JUCameraController: Đang đợi người chơi xuất hiện để bám theo...");
                }
            }
            //Set Start Rotation
